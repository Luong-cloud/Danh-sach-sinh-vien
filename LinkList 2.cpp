...
public:
    ...
    void insertAtEnd(string value) {
        ...
        // Update the last node's next next to the new node 
        temp->next = newNode;
    }
...
int main() {
    ...
    list1.insertAtEnd("Luong");
    list1.insertAtEnd("Hoàng");

    // Insert element at the beginning
    list1.insertAtBeginning("Bảo");

    // Insert element at a specific position
    list1.insertAtPosition("Long", 3);
